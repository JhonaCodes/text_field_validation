...
class RegularExpression {
  ...
  /// Validate address
  static bool validateAddress(String address) => regExp(r'^[a-zA-Z0-9 ]+$', address);
  ...
  /// Validate country
  static bool validateCountry(String country) => regExp(r'^[a-zA-Z ]+$', country);

  /// Validate card number
  static bool validateCardNumber(String cardNumber) => regExp(r'^[0-9]{16}$', cardNumber);

  /// Validate card holder
  static bool validateCardHolder(String cardHolder) => regExp(r'^[a-zA-Z ]+$', cardHolder);

  /// Validate card date
  static bool validateCardDate(String cardDate) => regExp(r'^[0-9]{2}\/[0-9]{2}$', cardDate);
  ...
  /// Validate card type
  static bool validateCardType(String cardType) => regExp(r'^[a-zA-Z ]+$', cardType);

  /// Validate card name
  static bool validateCardName(String cardName) => regExp(r'^[a-zA-Z ]+$', cardName);

  /// Validate card address
  static bool validateCardAddress(String cardAddress) => regExp(r'^[a-zA-Z0-9 ]+$', cardAddress);

  /// Validate card city
  static bool validateCardCity(String cardCity) => regExp(r'^[a-zA-Z ]+$', cardCity);

  /// Validate card state
  static bool validateCardState(String cardState) => regExp(r'^[a-zA-Z ]+$', cardState);
  ...
  static bool validatePhoneNumberAndIndicative(String phoneNumber) => regExp(r'^\+[1-9]{1}[0-9]{3,14}$', phoneNumber);

  /// Validate date born (format YYYY/MM/DD)
  static bool validateDateBornYYYYMMDD(String dateBorn) => regExp(r'^[0-9]{4}\/[0-9]{2}\/[0-9]{2}$', dateBorn);

  /// Validate date born (format MM/DD/YYYY)
  static bool validateDateBornMMDDYY(String dateBorn) => regExp(r'^[0-9]{2}\/[0-9]{2}\/[0-9]{4}$', dateBorn);

  /// Validate date born (format DD/MM/YYYY)
  static bool validateDateBornDDMMYYYY(String dateBorn) => regExp(r'^[0-9]{2}\/[0-9]{2}\/[0-9]{4}$', dateBorn);

  /// Validate date born (format YYYY-MM-DD)
  static bool validateDateBornYYYYMMDD2(String dateBorn) => regExp(r'^[0-9]{4}\-[0-9]{2}\-[0-9]{2}$', dateBorn);

  /// Validate date born (format DD-MM-YYYY)
  static bool validateDateBornDDMMYYYY2(String dateBorn) => regExp(r'^[0-9]{2}\-[0-9]{2}\-[0-9]{4}$', dateBorn);

  /// Validate date born (format MM-DD-YYYY)
  static bool validateDateBornMMDDYYYY(String dateBorn) => regExp(r'^[0-9]{2}\-[0-9]{2}\-[0-9]{4}$', dateBorn);

  /// Validate date born (format YYYY.MM.DD)
  static bool validateDateBornYYYYMMDD3(String dateBorn) => regExp(r'^[0-9]{4}\.[0-9]{2}\.[0-9]{2}$', dateBorn);

  /// Validate date born (format DD.MM.YYYY)
  static bool validateDateBornDDMMYYYY3(String dateBorn) => regExp(r'^[0-9]{2}\.[0-9]{2}\.[0-9]{4}$', dateBorn);

  /// Validate date born (format MM.DD.YYYY)
  static bool validateDateBornMMDDYYYY2(String dateBorn) => regExp(r'^[0-9]{2}\.[0-9]{2}\.[0-9]{4}$', dateBorn);

  /// Validate date born (format YYYY MM DD)
  static bool validateDateBornYYYYMMDD4(String dateBorn) => regExp(r'^[0-9]{4}\ [0-9]{2}\ [0-9]{2}$', dateBorn);

  /// Validate date born (format DD MM YYYY)
  static bool validateDateBornDDMMYYYY4(String dateBorn) => regExp(r'^[0-9]{2}\ [0-9]{2}\ [0-9]{4}$', dateBorn);
  ...
  /// Validate BIC
  static bool validateBIC(String bic) => regExp(r'^[A-Z]{6}[A-Z0-9]{2}([A-Z0-9]{3})?$', bic);

  /// Validate DNS.
  static bool validateDNS(String dns) => regExp(r'^([a-z0-9]+(-[a-z0-9]+)*\.)+[a-z]{2,}$', dns);
  ...
  /// Validate weights.
  static bool validateWeights(String weights) => regExp(r'^[0-9]+([,.][0-9]+)?$', weights);

  /// Validate height.
  static bool validateHeight(String height) => regExp(r'^[0-9]+([,.][0-9]+)?$', height);
  ...
  /// Validate number.
  static bool validateNumber(String number) => regExp(r'^[0-9]+([,.][0-9]+)?$', number);
  ...
  static bool validateMACAddress(String macAddress) => regExp(r'^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$', macAddress);
