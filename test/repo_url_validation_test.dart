...
void main() {
  group("REPO_URL_VALIDATION_TEST", () {
    ...
    test("github_invalid_test", () {
      expect(TextFieldValidation.gitHub("invalid_github_url"),
    ...
    test("gitlab_invalid_test", () {
      expect(TextFieldValidation.gitLab("invalid_gitlab_url"),
          'Please enter a valid gitlab url');
    });
    ...
    test("captcha_invalid_test", () {
      expect(TextFieldValidation.captcha("invalid_captcha"),
